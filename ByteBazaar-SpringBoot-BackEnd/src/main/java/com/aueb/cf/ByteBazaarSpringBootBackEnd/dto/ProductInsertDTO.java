...
/**
 * Data Transfer Object (DTO) for inserting a product.
 * Represents product information received from the client.
 * Used for creating new product entries in the system.
 *
 * @author Chris
 * @version 1.0
 */
